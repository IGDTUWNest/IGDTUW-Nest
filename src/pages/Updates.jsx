  ...
  const seniorTips = [
    {
      ...
      color: "border-brand-pink/30 hover:border-brand-pink bg-brand-pink/5 shadow-sm"
    },
    {
      ...
      color: "border-brand-purple/30 hover:border-brand-purple bg-brand-purple/5 shadow-sm"
    },
    {
      author: "Ayushi",
      ...
      color: "border-blue-300 hover:border-blue-400 bg-blue-50/50 shadow-sm"
    },
    {
      ...
      color: "border-amber-300 hover:border-amber-400 bg-amber-50/50 shadow-sm"
    },
    {
      author: "Stuti Shukla",
      ...
      color: "border-pink-300 hover:border-pink-400 bg-pink-50/50 shadow-sm"
    },
    {
    ...
    },
    {
      ...
      color: "border-rose-300 hover:border-rose-400 bg-rose-50/50 shadow-sm"
    },
    {
    ...
    },
    {
      ...
      color: "border-emerald-300 hover:border-emerald-400 bg-emerald-50/50 shadow-sm"
    },
    {
      ...
      color: "border-red-300 hover:border-red-400 bg-red-50/50 shadow-sm"
    },
    {
      ...
      color: "border-cyan-300 hover:border-cyan-400 bg-cyan-50/50 shadow-sm"
    }
  ];
  ...
  return (
    <div className="relative min-h-screen pt-28 pb-12 overflow-hidden flex flex-col items-center">
      ...
      <motion.button
        ...
        className="fixed top-24 left-6 z-40 p-4 rounded-full bg-brand-pink text-white shadow-md border border-brand-pink/20 hover:bg-brand-pink/90 transition duration-300 focus:outline-none flex items-center justify-center"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
          {seniorTips.map((note, idx) => (
            ...
            >
              ...
              <div className="mt-5 pt-3 border-t border-slate-200/50 text-right font-extrabold text-xs sm:text-sm text-slate-700 italic">
                – {note.author}
              </div>
            </motion.div>
          ))}
        ...
        {panelOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 w-[85vw] sm:w-[380px] bg-white/95 border-r border-slate-200/60 z-50 p-6 flex flex-col justify-between backdrop-blur-xl"
            >
              <div className="flex-1 flex flex-col overflow-hidden space-y-6 mb-6">
                {/* Header */}
                <div className="flex items-center justify-between pb-4 border-b border-slate-200/50 flex-shrink-0">
                  ...
                  <button
                    onClick={() => setPanelOpen(false)}
                    className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-500 hover:text-slate-700 transition duration-200"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                <div className="flex-1 overflow-y-auto space-y-4 pr-1.5 scrollbar-thin scrollbar-thumb-brand-pink">
                  ...
                  >
                    ...
                    <h4 className="font-bold text-xs sm:text-sm text-slate-800 group-hover:text-brand-pink transition duration-200 pr-12">
                      📌 Upcoming Hackathons!
                    </h4>
                  ...
                  <div className="p-4 rounded-2xl bg-amber-50/40 border border-amber-200 relative">
                    <span className="absolute top-3 right-3 bg-amber-500/20 text-amber-600 text-[9px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
                      ACTIVE
                    </span>
                    <h4 className="font-bold text-xs sm:text-sm text-amber-800">
                      ☀️ Summer Vacation Started
                    </h4>
                    <p className="text-xs text-slate-500 mt-1 font-semibold leading-relaxed">
                      <span className="text-slate-700 font-bold block mb-0.5">June 2, 2026</span>
                  ...
                  <div className="p-4 rounded-2xl bg-emerald-50/40 border border-emerald-200 relative">
                    <span className="absolute top-3 right-3 bg-emerald-500/20 text-emerald-600 text-[9px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
                      INFO
                    </span>
                  ...
                  <div className="p-4 rounded-2xl bg-brand-purple/5 border border-brand-purple/20 relative">
                    ...
                    <h4 className="font-bold text-xs sm:text-sm text-brand-purple">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50/50 border border-slate-100 relative">
                    <span className="absolute top-3 right-3 bg-slate-200 text-slate-600 text-[9px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
                      NOTICES
                    </span>
              ...
              <div className="p-4 rounded-2xl bg-gradient-to-br from-brand-pink/15 to-brand-purple/15 border border-brand-pink/35 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-extrabold text-brand-dark uppercase tracking-wider">Suggestion Box</span>
                </div>
