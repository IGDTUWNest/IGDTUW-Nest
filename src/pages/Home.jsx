  ...
  return (
    <motion.div variants={itemVariants} className="h-full" style={{ perspective: 1100 }}>
      <Link
        ...
        className={`group relative flex flex-col justify-between p-6 h-64 rounded-3xl bg-white/85 backdrop-blur-xl border border-slate-200/60 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] transition-shadow duration-300 ${card.glow}`}
      >
        ...
        <div className="space-y-4 relative z-10" style={{ transform: "translateZ(30px)", transformStyle: "preserve-3d" }}>
          ...
          <div className="space-y-1.5">
            <h3 className="font-black text-xl text-slate-900 group-hover:text-pink-600 transition duration-200 tracking-tight">
              {card.title}
            </h3>
        ...
        <div className="mt-4 w-fit px-4 py-2 rounded-xl bg-slate-950 text-white text-[11px] font-black uppercase tracking-wider shadow-md group-hover:bg-pink-600 transition-all duration-300 flex items-center gap-1.5 relative z-10" style={{ transform: "translateZ(45px)" }}>
          <span>Explore</span>
...
export default function Home() {
  const cards = [
    { title: 'Find a Nest', description: 'PGs & Flats reviewed by students with honest details.', path: '/find-nest', icon: HomeIcon, bgGradient: 'from-pink-500/20 via-rose-500/10 to-transparent', accentColor: 'text-pink-600 border-pink-200 bg-pink-50', glow: 'hover:shadow-[0_30px_50px_rgba(219,39,119,0.2)] hover:border-pink-300' },
    { title: 'Student Spotlights', description: 'Our comfort cafés, chai corners, markets & sightseeing.', path: '/student-spot', icon: Compass, bgGradient: 'from-purple-500/20 via-indigo-500/10 to-transparent', accentColor: 'text-purple-600 border-purple-200 bg-purple-50', glow: 'hover:shadow-[0_30px_50px_rgba(147,51,234,0.2)] hover:border-purple-300' },
    { title: 'Campus Life', description: 'Societies, student hubs & our campus photo dump.', path: '/campus-life', icon: Play, bgGradient: 'from-blue-500/20 via-cyan-500/10 to-transparent', accentColor: 'text-blue-600 border-blue-200 bg-blue-50', glow: 'hover:shadow-[0_30px_50px_rgba(37,99,235,0.2)] hover:border-blue-300' },
    { title: 'Updates & Tips', description: 'Seniors real talk, IGDTUW hacks & notices.', path: '/updates', icon: Bell, bgGradient: 'from-amber-500/20 via-orange-500/10 to-transparent', accentColor: 'text-amber-600 border-amber-200 bg-amber-50', glow: 'hover:shadow-[0_30px_50px_rgba(217,119,6,0.2)] hover:border-amber-300' }
  ];
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-12 overflow-hidden flex flex-col items-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/backimg.png')" }}>
      ...
      <div className="absolute inset-0 bg-white/80 backdrop-blur-[12px] -z-10 bg-gradient-to-b from-white/90 via-slate-50/80 to-purple-50/70" />
      <AnimatedBg />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 flex-1 flex flex-col justify-center gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="text-center py-6 flex flex-col items-center gap-4">
          <div className="w-20 h-20 rounded-2xl overflow-hidden border-2 border-white/90 bg-white p-1 shadow-2xl">
            <img src="/WhatsApp Image 2025-04-10 at 11.58.50.jpeg" alt="Nest Logo" className="w-full h-full object-contain" />
          </div>
          <div className="space-y-3">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent drop-shadow-sm">
              Welcome to IGDTUW Nest
            </h1>
            <div className="inline-block px-6 py-2 rounded-full bg-white/90 border border-slate-200/80 shadow-md backdrop-blur-md">
              <p className="text-xs sm:text-sm text-slate-800 font-extrabold tracking-wide">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="my-6 rounded-[2rem] bg-white border-2 border-slate-900 p-8 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] relative overflow-hidden"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left relative z-10 w-full lg:w-auto">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-center sm:justify-start gap-2">
                <span className="px-2.5 py-0.5 rounded-md bg-purple-100 text-purple-700 font-black text-[10px] uppercase tracking-widest border border-purple-200">Hub</span>
                <h4 className="font-black text-xl text-slate-900 tracking-tight">
                  Join our Student Communities!
                </h4>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 font-bold max-w-xl leading-normal">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto relative z-10">
            <a
              ...
              className="group/btn px-6 py-3.5 rounded-xl bg-slate-950 text-white text-xs font-black uppercase tracking-widest shadow-md hover:bg-pink-600 hover:shadow-[0_10px_20px_rgba(219,39,119,0.3)] transition-all duration-300 text-center flex items-center justify-center gap-2 border-b-4 border-slate-800"
            >
