  ...
  return (
    <div className="relative min-h-screen pt-28 pb-12 overflow-hidden flex flex-col items-center">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 space-y-8 flex-1 flex flex-col">
        ...
        <div className="flex justify-center border-b border-slate-200/50 pb-1">
          <div className="flex bg-slate-100/80 border border-slate-200/60 p-1.5 rounded-2xl gap-1">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition duration-300 focus:outline-none ${
                    active
                      ? 'bg-brand-pink/10 text-brand-pink shadow-[0_0_15px_rgba(244,114,182,0.1)]'
                      : 'text-slate-500 hover:text-brand-pink hover:bg-brand-pink/5'
                  }`}
                >
