        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-brand-purple/10 hover:text-brand-purple text-slate-600 text-xs border border-slate-200 transition duration-300 shadow-sm font-bold"
            >
              <Mail className="w-3.5 h-3.5" />
              <span>igdtuwnest@gmail.com</span>
            </a>
          </div>
        </div>
